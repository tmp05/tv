...
public class VideoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		overridePendingTransition(ru.ks.tv.R.anim.anim_enter_right, ru.ks.tv.R.anim.anim_leave_left);
	...
	public void onBackPressed() {
		...
		super.onBackPressed();
		overridePendingTransition(ru.ks.tv.R.anim.anim_enter_left, ru.ks.tv.R.anim.anim_leave_right);
		((VideoInterface)mVideoSurface).end();
	}
